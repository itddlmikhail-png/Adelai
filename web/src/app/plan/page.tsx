    ...
    <main className="min-h-[100svh] bg-ink">
      ...
      <div className="mx-auto max-w-content px-6 pb-16 pt-28 md:px-8 md:pt-32">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-3 font-display text-[clamp(2.2rem,5vw,3.4rem)] font-semibold tracking-tight">
            План
          </h1>
          <p className="mt-4 text-[17px] text-mist">
            Выберите тариф Adelai. Начните бесплатно — откройте полный AI OS с Pro.
          </p>
        </div>
